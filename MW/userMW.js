...
exports.userValaidationAdd = [
    ...
    body("userPhone")
        ...
        .notEmpty().withMessage("userPhone is required")
        .isNumeric().withMessage("userPhone must be a number")
...
exports.userValaidationUpdate = [
    body("userFullName")
        ...
        .withMessage("userName must be between 3 and 50 characters long"),
    body("userEmail")
        .optional().isEmail().withMessage("userEmail must be a valid email")
        .isLength({ min: 3, max: 50 })
        .withMessage("userEmail must be between 3 and 50 characters long"),
    body("userPhone")
        .optional().isNumeric().withMessage("userPhone must be a number")
        .isLength({ min: 11, max: 11 })
        .withMessage("userPhone must be 11 characters long"),
    body("userPassword")
...
exports.userValidationDeleteOrder = [
    ...
    ,
    body("userOrder")
        .notEmpty().withMessage("userOrder is required")
        .isArray(Number).withMessage("userOrder must be an array of numbers")
